...
try:
  ...
  no_words_to_be_predicted, select_model, enter_input_text = set_model_config(no_words_to_be_predicted=1, select_model = "bert", enter_input_text = "why are you leaving me when I")
